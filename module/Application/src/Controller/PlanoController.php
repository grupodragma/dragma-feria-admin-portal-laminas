...
class PlanoController extends AbstractActionController {
    ...
    public function __construct($serviceManager, $objPlanosTable, $objEmpresasTable, $objProductosTable, $objTipoHabitacionTable, $objNumeroHabitacionTable) {
    ...
    public function listarPlanosAction(){
        $dataPlanos = $this->objPlanosTable->obtenerPlanos();
        $data_out = [];
        $data_out['data'] = [];
    ...
    public function agregarPlanosAction(){
        $data=[
            ...
            'proyectos'=> $this->objProductosTable->obtenerProductos(),
    ...
    public function guardarAgregarPlanosAction(){
        ...
        $data = [
            'idproductos'=>$datosFormulario['idproductos'],
    ...
    public function editarPlanosAction(){
        ...
        $dataPlanos['empresas'] = $this->objEmpresasTable->obtenerEmpresas($this->sessionContainer['idferias'], $this->sessionContainer['idperfil']);
        $dataPlanos['proyectos'] = $this->objProductosTable->obtenerProductos();
        $dataPlanos['tipoHabitaciones'] = $this->objTipoHabitacionTable->obtenerTipoHabitacion();
        $dataPlanos['numeroHabitaciones'] = $this->objNumeroHabitacionTable->obtenerNumeroHabitacion();
