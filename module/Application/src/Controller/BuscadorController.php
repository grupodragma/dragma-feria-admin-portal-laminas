...
class BuscadorController extends AbstractActionController {
    ...
    public function listarBuscadorAction(){
        $dataBuscador = $this->objBuscadorTable->obtenerBuscador($this->sessionContainer['idferias'], $this->sessionContainer['idperfil']);
        $data_out = [];
        $data_out['data'] = [];
    ...
    public function editarBuscadorAction(){
        ...
        $dataBuscador['empresas'] = $this->objEmpresasTable->obtenerEmpresas($this->sessionContainer['idferias'], $this->sessionContainer['idperfil']);
