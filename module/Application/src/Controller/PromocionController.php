...
class PromocionController extends AbstractActionController {
    ...
    public function __construct($serviceManager, $objPromocionesTable, $objEmpresasTable, $objProductosTable) {
    ...
    public function listarPromocionesAction(){
        $dataPromociones = $this->objPromocionesTable->obtenerPromociones();
        $data_out = [];
        $data_out['data'] = [];
    ...
    public function editarPromocionesAction(){
        ...
        $dataPromociones['empresas'] = $this->objEmpresasTable->obtenerEmpresas($this->sessionContainer['idferias'], $this->sessionContainer['idperfil']);
        $dataPromociones['proyectos'] = $this->objProductosTable->obtenerProductos();
