...
class OfertaController extends AbstractActionController {
    ...
    public function listarOfertasAction(){
        ...
        foreach($dataOfertas as $item){
            if($item['estado']>0){ $estado='Abierto';} else{ $estado='Cerrado';}
    ...
    public function editarOfertasAction(){
        ...
        $dataOfertas['empresas'] = $this->objEmpresasTable->obtenerEmpresas($this->sessionContainer['idferias'], $this->sessionContainer['idperfil']);
