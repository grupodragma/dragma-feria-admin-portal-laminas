...
class FeriasTable {
    ...
    public function listarFeriasVisitantes($idferias, $fecha=null){
        ...
        if( $idferias != null ) $condiciones[] = "v.idferias = {$idferias}";
        if($fecha!=null)$condiciones[] = "v.fecha_registro_web >= '{$fecha_inicio} 00:00:00' AND v.fecha_registro_web <= '{$fecha_fin} 23:59:59'";
